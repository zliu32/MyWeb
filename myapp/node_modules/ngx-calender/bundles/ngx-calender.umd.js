(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('date-fns')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', 'date-fns'], factory) :
	(factory((global['ngx-calender'] = {}),global.ng.core,global.ng.common,global.dateFns));
}(this, (function (exports,core,common,dateFns) { 'use strict';
...
var NgxCalenderComponent = (function () {
    ...
    function NgxCalenderComponent(renderer) {
        ...
        this.clickedDate = new core.EventEmitter();
    ...
    NgxCalenderComponent.prototype.ngOnInit = function () {
        ...
        this.currentDate = dateFns.format(new Date(), 'D');
        this.currentMonth = dateFns.format(new Date(), 'MMMM');
        this.currentYear = Number(dateFns.format(new Date(), 'YYYY'));
        this.currDaysInCurrMonth = dateFns.getDaysInMonth(new Date());
        this.currMonthFirstDay = (Number(dateFns.format(dateFns.startOfMonth(new Date()), 'd')) - 1);
    };
    /**
     * @return {?}
     */
    ...
    NgxCalenderComponent.prototype.clickHandler = function (evt) {
        if (evt.currentTarget['innerText'] !== '') {
            ...
            var /** @type {?} */ date = dateFns.parse(this.currentYear + "-" + this.currentMonth + "-" + this.currentDate);
...
NgxCalenderComponent.propDecorators = {
    ...
    'clickedDate': [{ type: core.Output },],
    'tdCollection': [{ type: core.ViewChildren, args: ['tdCell',] },],
};
...
exports.ɵa = NgxCalenderComponent;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-calender.umd.js.map
